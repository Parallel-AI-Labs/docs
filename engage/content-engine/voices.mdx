---
title: "Voices"
description: "Clone custom voices or use ready-made ones for your audio."
icon: "microphone"
---
...
> **You don't have to clone a voice to get started.** A large library of ready-made voices is available to use immediately in [Audio](/engage/content-engine/audio). Clone a voice only when you want a specific person's or brand's voice. Cloned voices are private to your company; ready-made voices are available to everyone.
...
- [Generate Audio with Your Voice](/engage/content-engine/audio)
- [Create Videos](/engage/content-engine/video)
