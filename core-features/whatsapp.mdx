---
title: "WhatsApp"
description: "Let customers message your agent on WhatsApp and get answers instantly. WhatsApp runs on Twilio — the same connection that powers your SMS and voice channels."
---
...
- [Agents](/core-features/agents) — building and configuring agents
- [Integrations](/admin-features/integrations) — connecting Twilio and other services
- [Inbox](/workflow-features/inbox) — managing conversations across channels
