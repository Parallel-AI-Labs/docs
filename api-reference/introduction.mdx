...
<CardGroup cols={3}>
  ...
  <Card title="Smart Lists" icon="list-check" href="/api-reference/smart-lists/list">
    Manage contact lists and the contacts within them.
  </Card>
  <Card title="Sequences" icon="diagram-next" href="/api-reference/sequences/list">
    Build and trigger multi-step automated messaging sequences.
  </Card>
  <Card title="Documents" icon="file-lines" href="/api-reference/documents/list">
    Upload and manage knowledge base documents for your agents.
  </Card>
  <Card title="Audio / Media" icon="waveform" href="/api-reference/audio/list">
    Transcribe audio and manage media assets.
  </Card>
  <Card title="Browser" icon="browser" href="/api-reference/browser/submit">
    Extract web content for use in agent knowledge bases.
  </Card>
  <Card title="Keys" icon="key" href="/api-reference/keys/list">
    Create and manage Company API Keys and Personal Access Keys.
  </Card>
  <Card title="MCP" icon="plug" href="/api-reference/mcp/overview">
