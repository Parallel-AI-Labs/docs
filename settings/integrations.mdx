---
title: "Integrations"
description: "Connect CRMs, email, data providers, social platforms, and other services."
icon: "plug"
---
...
List actions use integrations to enrich and sync your data — for example, **Apollo Enrichment**, **Sync to CRM**, or an **HTTP Request** to your own API. See [Smart Lists](/find-enrich/smart-lists) for details.
...
See [Sequences](/engage/sequences) for details.
...
- [Set Up Email Sequences](/engage/sequences)
- [Manage Your Knowledge Base](/overview/knowledge-base)
