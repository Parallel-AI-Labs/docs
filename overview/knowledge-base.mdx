...
description: "Upload the documents, websites, and files that train your AI employees."
icon: "lightbulb"
---
...
- **Avoid:** "doc_v2_final_FINAL"
- **Better:** "Return Policy - Updated January 2024"
...
A: Yes! Check the [Integrations](/settings/integrations) page for available connections.

## Next Steps

- [Create AI Employees](/overview/employees)
- [Start Chatting](/overview/chat)
- [Connect External Tools](/settings/integrations)
